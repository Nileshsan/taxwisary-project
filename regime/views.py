...
def calculate_old_regime_tax(salary, hra, deductions):
    taxable_income = max(salary - hra - deductions, 0)
...
def regime_advice_logic(salary, hra, deductions):
    ...
    if old_tax < new_tax:
        ...
        # Default to new regime (or choose based on your logic)
        selected = {
            "taxable_income": new_taxable_income,
            "tax": new_tax
        }
    ...
    return {
        ...
        "selected_regime": selected,  # This is the optimal outcome based on our criteria
        "old_regime": {
            "taxable_income": old_taxable_income,
            "tax": old_tax
        },
